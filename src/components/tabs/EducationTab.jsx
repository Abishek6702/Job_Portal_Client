...
const EducationTab = ({ education }) => (
  <div className=" rounded-2xl  p-8">
    ...
    {(!education || education.length === 0) && (
      <div className="text-gray-500 text-center py-8">No education details found.</div>
    )}
          ...
          <li key={idx} className="relative pl-10">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 transition hover:shadow-lg">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                <span className="font-semibold text-blue-700 text-lg">{edu.level}</span>
              ...
              <div className="text-gray-500 text-sm mt-1">
                <span className="mr-4"><b>Branch:</b> {edu.branch || "N/A"}</span>
                <span><b>Marks:</b> {edu.marks || "N/A"}</span>
              </div>
            </div>
          </li>
        ))}
