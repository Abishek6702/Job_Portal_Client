...
const InProgressApplicationsPage = () => {
  ...
  const [statusModalApplicationIds, setStatusModalApplicationIds] = useState(
    []
  );
    ...
    const fetchApplications = async () => {
      try {
        ...
        const filteredApplications = allApplications.filter(
          (app) =>
            app.jobId && app.jobId._id === jobId && app.status === "in progress"
        );

        setApplications(filteredApplications);
        setOriginalApplications(filteredApplications);
        console.log("ak", filteredApplications);
    ...
    <div className="container mx-auto px-4">
      ...
      {isStatusModalOpen && (
        <InprogressApplicationStatusChange
          ...
          applicationIds={statusModalApplicationIds}
          isBulk={isBulkStatus}
