...
const EmployerProfile = () => {
  ...
  return (
    <div className="main_container">
      {companyIdToEdit?(<CompanyUpdateForm
                company={companyToEdit}
                onCancel={handleCancelEdit}
              />):( <div className="w-[90%] m-auto mt-4 border border-gray-300 rounded-md bg-white shadow-sm">
                {/* Profile Section */}
                      ...
                      <img
                        src={
                          company?.company_logo
                            ? `${import.meta.env.VITE_API_BASE_URL}/${company.company_logo.replace(
                                /\\/g,
                                "/"
                              )}`
                ...
                <Element name="Gallery" className="pt-6">
                  ...
                  >
                    {visibleImages?.map((imgPath, index) => {
                      ...
                      const fullImageUrl = `${import.meta.env.VITE_API_BASE_URL}/${normalizedPath}`;
                      return (
                        <div
                          key={index}
